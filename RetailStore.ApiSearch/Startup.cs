...
using RetailStore.ApiSearch.BAL.Services;

namespace RetailStore.ApiSearch
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            }).AddTransientHttpErrorPolicy(p => p.WaitAndRetryAsync(5,r => TimeSpan.FromMilliseconds(500)));
